...
import "../ArcadeNew/css/ConfirmPopup.css";

const ConfirmPopupRoseViews = (props) => {
      ...
      const putPaidState =async()=>{
        ...
        try {
          window.location.reload();
            ...
            console.log(paid)
            const req = await axios.put('http://alldaygrow.tplinkdns.com:3001/user-RoseViews-paid',paid)
        } catch (err) {
            console.error(err)
        } finally {
        }
...
export default ConfirmPopupRoseViews;
