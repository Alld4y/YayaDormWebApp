...
import MonthlyComponentBMJ from "./MonthlyComponentBMJ";
import ConfirmPopupBMJ from "./ConfirmPopupBMJ";
import "../ArcadeNew/css/ArcadeNewApp.css";
const BanMaejoeApp = (props) => {
    ...
    <>
      <div className="Acn-app-container">
        <div className="app-header">
          <h1>ข้อมูลผู้เช่า บ้านป่าไผ่</h1>
          {userData.map((userData) => {
            return (
              <div key={userData.id}>
                  ...
                  {showConfirmPopup && <ConfirmPopupBMJ closeConfirmPopup={closeConfirmPopup} paidId={paidId} paidMonth={paidMonth}/>}
                  <MonthlyComponentBMJ value={getPaidData} refresh={showConfirmPopup}/>
              </div>
            );
          })}
        </div>
